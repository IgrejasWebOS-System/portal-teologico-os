      ...
      <header className="bg-iw-navy shadow-lg">
        <div className="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <Link
              href="/"
              className="ml-2 inline-flex items-center gap-1.5 text-xs font-bold text-black bg-[#E88D0C] hover:opacity-90 rounded-lg px-3 py-1.5 transition-opacity shrink-0 border border-black"
            >
