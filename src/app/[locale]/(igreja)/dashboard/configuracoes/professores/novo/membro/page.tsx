    ...
    <div className="w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-2">
        <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
          ...
          <p className="text-iw-muted text-sm">(por matrícula ou nome) Campo/Setor/Igreja.</p>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          <Link
            href="/dashboard/configuracoes/professores/novo/externo"
            className="px-5 py-2.5 rounded-xl bg-iw-gold text-white text-sm font-bold uppercase tracking-wider hover:opacity-90 transition-opacity shadow-sm inline-flex items-center gap-2"
          >
          ...
          <Link
            ...
            className="px-5 py-2.5 rounded-xl bg-iw-blue text-white text-sm font-bold uppercase tracking-wider hover:bg-iw-navy transition-colors shadow-sm inline-flex items-center gap-2"
          >
