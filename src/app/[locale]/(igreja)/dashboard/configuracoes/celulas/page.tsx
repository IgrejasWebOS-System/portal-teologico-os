      ...
      <div className="bg-iw-surface rounded-2xl border border-iw-border overflow-hidden shadow-sm">
        ...
        {rows.length === 0 ? (
          <div className="px-5 py-12 text-center">
            <GitBranch className="w-10 h-10 text-iw-muted/30 mx-auto mb-3" />
            <p className="text-iw-muted text-sm font-medium">Nenhuma célula cadastrada.</p>
            <p className="text-iw-muted/60 text-xs mt-1">
              Clique em &ldquo;Nova Célula&rdquo; para começar.
            </p>
          </div>
        ) : (
