...
export default async function EscolaDetailPage({ params, searchParams }: Props) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <Link href="/escola" className="inline-flex items-center gap-1.5 text-sm text-iw-muted hover:text-iw-navy transition-colors">
        <ChevronLeft className="w-4 h-4" /> Escola Teológica
      </Link>
