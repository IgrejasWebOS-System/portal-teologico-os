        ...
        {ESTADOS_BR.map((e) => {
          ...
          return (
            <button
              ...
              className={`aspect-square rounded-lg flex items-center justify-center text-[10px] font-bold uppercase text-black transition-colors border ${
                selecionado
                  ? "bg-iw-blue/40 border-2 border-iw-navy"
                  : temCobertura
                  ? "bg-iw-blue/20 border-iw-blue/30 hover:bg-iw-blue/30"
                  : "bg-iw-bg border-iw-border hover:bg-iw-border/60"
              }`}
            >
              {e.uf}
            </button>
